...
def save_checkpoint(path_to_job, save_path, model, optimizer, epoch, cfg, scaler=None):
    """
    Save a checkpoint.
    Args:
    ...
    #path_to_checkpoint = get_path_to_checkpoint(path_to_job, epoch + 1) LF changing save name 
    path_to_checkpoint = save_path
